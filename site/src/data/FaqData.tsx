...
const data: { sectionTitle: string, questions: { question: string, answer: FunctionalComponent }[] }[] = [
   {
      ...
      questions: [
         ...
         },
         {
            ...
            answer: () => <p>
               While, some jurisdictions allow individuals to travel and work the polls even if they are not registered to vote in that location, for the most part, individuals
               are only allowed to serve in the state where they reside.
            </p>,
         },
         {
            question: "I’m not a U.S. citizen / I’m a permanent resident. Can I serve as a poll worker?",
            answer: () => <p>
               In most states you cannot work the polls unless you are a registered voter and citizen. The best place to find guidance is with your local administrator.
            </p>,
         },
         {
         ...
         },
         {
            ...
            answer: () => <div>
               <p>
                  Some jurisdictions allow workers to sign up for shifts, while others require you to work full days. However, you should still sign up and let your
                  election officials know about your availability. If your jurisdiction requires a full day of work and you can’t make those hours but still want
                  to help, think about recruiting other people you know to be a poll worker and can serve for the full time needed.
               </p>
               <p>
                  If your jurisdiction requires a full day of work and you can’t make those hours but still want to help, think about recruiting other people you know
                  to be a poll worker and can serve for the full time needed.
               </p>
            </div>,
         },
      ],
   },
   {
      ...
      questions: [
         ...
         },
         {
            ...
            answer: () => <p>
               Poll working is usually a non-partisan activity and your party affiliation does not matter, but in some states poll workers are matched to locations in
               pairs based on their party registration. This is sometimes done to ensure party balance among poll workers at every polling location. Applications in
               some jurisdictions may ask you for party registration information.
            </p>,
         },
      ],
   },
      ...
      questions: [
         {
            ...
            answer: () => <p>
               Unfortunately, Power the Polls can’t mail you an application -- but we can connect you with the people who can. You should <stencil-route-link url="/search"> reach out to your local administrators</stencil-route-link> for information on how to proceed.
            </p>,
         },
      ],
   },
      ...
      questions: [
         {
            ...
            answer: () => <p>
               We will be in touch to help you through the process, but also be sure to be on the lookout for any communication from your local election administrators!
            </p>,
         },
         {
            question: "Do poll workers need training?",
         ...
         },
         {
            ...
            answer: () => <div>
               <p>
                  If you've already <stencil-route-link url="/signup#form">applied</stencil-route-link>, you can check in to see if your local administrator has posted new training information.
                  In some places, there are online trainings you can start immediately.
               </p>
         ...
         },
         {
            ...
            answer: () => <p>
               While there is a great need for poll workers right now, many election administrators do not reach out to poll worker applicants until closer to Election Day.
            </p>,
         },
         {
            ...
            answer: () => <div>
               <p>
                  Most election administrators accept applications on a rolling basis, so we do not have a set deadline nationwide or even state-by-state. However,
                  administrators make decisions about the number of polling locations they plan to open based on the number of poll workers they have, so getting
                  applications in as early as possible is important to help administrators in their planning.
               </p>
               <p>
                  If you’re ready to get started, please begin your signup process <stencil-route-link url="/signup#form">here</stencil-route-link>.
               </p>
            </div>,
         },
         {
   ...
   },
   {
      ...
      questions: [
         ...
         },
         {
            ...
            answer: () => <p>
               Unfortunately, we cannot process your application directly - but we can connect you with the people who can. You should reach out to your local administrators for information on how to proceed.
            </p>,
         },
         {
