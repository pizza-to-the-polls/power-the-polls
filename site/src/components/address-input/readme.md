...
| --------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------ | --------------------- | ----------- |
| `lookupDelay`         | `lookup-delay`           | Delay, in ms, between user pressing a key while entering an address and the API call being made. Default: 200 (ms) | `number`              | `undefined` |
