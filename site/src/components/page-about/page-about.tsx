   ...
   public render() {
      return (
         <Host>
            ...
            <p>
               Most poll workers are over the age of 60 and, in the era of uncertainty caused by the coronavirus,
               fewer are signing up for the job (<a target="_blank" rel="noopener" href="https://www.pewresearch.org/fact-tank/2020/04/06/older-people-account-for-large-shares-of-poll-workers-and-voters-in-u-s-general-elections/" title="Open source in a new window">source</a>).
            </p>
            <p>
               The consequences have already been felt in several recent primaries, where poll worker shortages
               led to long lines and voter disenfranchisement. For example, 95% of past poll workers in Anchorage,
               AK, declined to work the polls this year (<a href="https://www.theatlantic.com/ideas/archive/2020/06/looming-threat-voting-person/613552/" target="_blank" rel="noopener" title="Open source in a new window">source</a>)
               and the state of Kentucky consolidated in-person voting in each county to a single polling place
               during the primary due to poll worker recruitment concerns.
            </p>
