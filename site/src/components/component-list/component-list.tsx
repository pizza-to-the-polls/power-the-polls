...
export class ComponentList {
   ...
   public render() {
      const items = [
         ...
         {
            tag: "ui-social-share",
            example: <ui-social-share image="icon-fb.svg" name="SocialNetworkName" cta="Social Share" url="#" />,
         },
         {
            tag: "ui-social-share invertColors=true",
            example: <ui-social-share invertColors={true} image="icon-ig.svg" name="SocialNetworkName" cta="Social Share" url="#" />,
         },
         {
            tag: "ui-impact-box",
